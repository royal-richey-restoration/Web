  ...
  return (
    <Html>
      <Head>
        ...
        <meta name="og:image" content="/logo-192x192.png" />
        <meta
          property="og:description"
          content="Hardwood Floor Repair and Restoration by the professionals in hardwood flooring: Royal Richey Restoration. Call: 727-267-2617"
        />
